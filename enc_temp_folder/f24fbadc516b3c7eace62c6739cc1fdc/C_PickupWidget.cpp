...
void UC_PickupWidget::DisplayHealth()
{
	...
	//FLinearColor White = FColor(0, 0, 0, 1);
	//PickupImage->SetBrushTintColor(White);
	//PickupImage->SetBrushTintColor(FLinearColor::);
	//PickupImage->SetColorAndOpacity(FColor(1, 1, 1, 1));
}
...
void UC_PickupWidget::DisplayStamina()
{
	...
	//FLinearColor White = FColor(0, 0, 0, 1);
	//PickupImage->SetBrushTintColor(White);
	//PickupImage->SetBrushTintColor(FLinearColor::Transparent);
	//PickupImage->SetColorAndOpacity(FColor(1, 1, 1, 1));
}
